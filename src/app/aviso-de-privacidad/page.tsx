      ...
      <main className="bg-white min-h-screen">
        ...
        <div className="max-w-3xl mx-auto px-6 py-16 space-y-12 text-[#1A1A1A]">
          ...
          <section>
            ...
            <ul className="text-sm font-light text-[#444] space-y-1.5 leading-relaxed">
              <li>
          ...
          <section>
            ...
            <div className="mb-5">
              ...
              <ul className="list-disc list-inside text-sm font-light text-[#444] space-y-1 leading-relaxed ml-1">
          ...
          <section>
            ...
            <div className="bg-[#0A1628] text-white rounded-xl p-5 mb-4">
              ...
              <p className="text-xs text-white/40 mt-1">Atención: Responsable de Datos Personales</p>
            </div>

            <p className="text-sm font-light text-[#444] mb-3 leading-relaxed">
              Su solicitud debe incluir:
            </p>
            <ul className="list-disc list-inside text-sm font-light text-[#444] space-y-1 leading-relaxed ml-1 mb-4">
              <li>Nombre completo</li>
