  ...
  return (
    ...
    >
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-whatsapp flex items-center justify-center shrink-0">
              ...
              <button
                ...
                className="text-ink-muted hover:text-[#1A1A1A] transition-colors"
              >
                <X size={14} />
              </button>
            </div>

            <p className="text-[13px] font-normal text-ink-muted leading-relaxed mb-3">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full bg-whatsapp hover:bg-whatsapp/90 text-white py-2.5 rounded-xl text-[12px] font-semibold transition-colors duration-200"
            >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 rounded-full bg-whatsapp shadow-[0_4px_20px_rgba(37,211,102,0.4)] flex items-center justify-center relative"
